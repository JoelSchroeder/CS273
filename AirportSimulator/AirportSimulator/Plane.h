...
struct Plane
{
	...
	int service_time; //the time this plane needs to be serviced
	int arrival_time; //when it arrived 
	int start_service_time; //when it begins servicing
	int ready_takeoff_time; //when it is ready to take off 
	int enter_departure_time; //when it enters the departure queue
};
